...
def execute(filters=None):
    ...
    group_wise_columns = frappe._dict({
        ...
        "item_code": ["item_code", "item_name", "brand", "description", "qty", "base_rate",
                      "buying_rate", "incoming_rate", "base_amount", "buying_amount", "gross_profit", "gross_profit_percent"],
        "warehouse": ["warehouse", "qty", "base_rate", "buying_rate", "incoming_rate", "base_amount", "buying_amount",
                      "gross_profit", "gross_profit_percent"],
        "brand": ["brand", "qty", "base_rate", "buying_rate",  "incoming_rate", "base_amount", "buying_amount",
                  "gross_profit", "gross_profit_percent"],
        "item_group": ["item_group", "qty", "base_rate", "buying_rate", "incoming_rate", "base_amount", "buying_amount",
                       "gross_profit", "gross_profit_percent"],
        "customer": ["customer", "customer_group", "qty", "base_rate", "buying_rate",  "incoming_rate", "base_amount", "buying_amount",
                     "gross_profit", "gross_profit_percent"],
        "customer_group": ["customer_group", "qty", "base_rate", "buying_rate",  "incoming_rate", "base_amount", "buying_amount",
                           "gross_profit", "gross_profit_percent"],
        "sales_person": ["sales_person", "allocated_amount", "qty", "base_rate", "buying_rate",  "incoming_rate", "base_amount", "buying_amount",
                         "gross_profit", "gross_profit_percent"],
...
class GrossProfitGenerator(object):
    ...
    def set_average_gross_profit(self, new_row):
        ...
        new_row.buying_rate = flt(
            new_row.buying_amount / flt(new_row.qty), self.float_precision) if flt(new_row.qty) else 0
        new_row.base_rate = flt(new_row.base_amount / flt(new_row.qty),
                                self.float_precision) if flt(new_row.qty) else 0
                ...
                for i, sle in enumerate(my_sle):
                    ...
                    if sle.voucher_type == parenttype and parent == sle.voucher_no and \
                        ...
                        if previous_stock_value:
                            return (flt(sle.valuation_rate)) * flt(row.qty)
                        else:
